...
setwd("/Users/akane/R_testing/Morgens_et_al_2019/figure_4/")

#Creates a list of csv files to be processed in this script.
files = list.files(pattern="*4e_rep*")
...
#ggsave('~/path/to/Fig/4E/plot.pdf', device = cairo_pdf(width = 10, height = 5))
